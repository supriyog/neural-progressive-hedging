...
from ray.rllib.optimizers.replay_buffer import ReplayBuffer, \
    PrioritizedReplayBuffer, ConsecutiveReplayBuffer
...
class SyncReplayOptimizer(PolicyOptimizer):
    ...
    def __init__(self,
        ...
        elif consecutive_replay:

            def new_buffer():
                return ConsecutiveReplayBuffer(
                    buffer_size, bias=consecutive_replay_bias)
