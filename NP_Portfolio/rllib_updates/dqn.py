...
DEFAULT_CONFIG = with_common_config({
    ...
    # If True and prioritized_replay = False recurrent replay buffer will be used.
    "consecutive_replay": True,
    "consecutive_replay_bias": 0.00005,
})
# __sphinx_doc_end__
# yapf: enable
...
def make_optimizer(workers, config):
    return SyncReplayOptimizer(
        ...
        consecutive_replay=config["consecutive_replay"],
        consecutive_replay_bias=config["consecutive_replay_bias"],
